...
public:
  ...
  DECLARE_ASYNC_METHOD(get_recent_txs_and_info);
  DECLARE_ASYNC_METHOD(get_recent_txs_and_info2);
  DECLARE_ASYNC_METHOD(transfer);
  DECLARE_ASYNC_METHOD(store);
  DECLARE_ASYNC_METHOD(get_payments);
  DECLARE_ASYNC_METHOD(get_bulk_payments);
