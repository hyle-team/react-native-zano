...
namespace margelo::nitro::zano {
  ...
  DEFINE_ASYNC_METHOD(get_recent_txs_and_info)
  DEFINE_ASYNC_METHOD(get_recent_txs_and_info2)
  DEFINE_ASYNC_METHOD(transfer)
  DEFINE_ASYNC_METHOD(store)
  DEFINE_ASYNC_METHOD(get_payments)
  DEFINE_ASYNC_METHOD(get_bulk_payments)
