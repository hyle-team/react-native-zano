...
export interface WalletRpc extends HybridObject<{ ios: 'c++'; android: 'c++' }> {
  ...
  search_for_transactions(instance_id: number, params: string): string;
  search_for_transactions2(instance_id: number, params: string): string;
  ...
  register_alias(instance_id: number, params: string): string;
  update_alias(instance_id: number, params: string): string;
