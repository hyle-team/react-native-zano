...
import type { alias_rpc_details, alias_rpc_details_base, API_RETURN_CODE, asset_descriptor_base, asset_descriptor_with_id, bc_performance_data, blobdata, block_header_response, block_rpc_extended_info, core_offers_filter, daemon_network_state, epee_hexemizer, maintainers_info_external, offer_details_ex, outs_index_stat, pool_performance_data, pos_entry, RANDOM_OUTPUTS_FOR_AMOUNTS_FLAGS, tx_generation_context, tx_rpc_brief_info, tx_rpc_extended_info, vote_results } from '../entities';
...
export declare enum DAEMON_RPC_GET_INFO_FLAG {
    POS_DIFFICULTY = 1,
    POW_DIFFICULTY = 2,
    NET_TIME_DELTA_MEDIAN = 4,
    CURRENT_NETWORK_HASHRATE_50 = 8,
    CURRENT_NETWORK_HASHRATE_350 = 16,
    SECONDS_FOR_10_BLOCKS = 32,
    SECONDS_FOR_30_BLOCKS = 64,
    TRANSACTIONS_DAILY_STAT = 128,
    LAST_POS_TIMESTAMP = 256,
    LAST_POW_TIMESTAMP = 512,
    TOTAL_COINS = 1024,
    LAST_BLOCK_SIZE = 2048,
    TX_COUNT_IN_LAST_BLOCK = 4096,
    POS_SEQUENCE_FACTOR = 8192,
    POW_SEQUENCE_FACTOR = 16384,
    OUTS_STAT = 32768,
    PERFORMANCE = 65536,
    POS_BLOCK_TS_SHIFT_VS_ACTUAL = 131072,
    MARKET = 262144,
    EXPIRATIONS_MEDIAN = 524288,
    ALL_FLAGS = 1048575
}
...
type CoreMethod<Params, Result, Errors = never> = {
    (params: TypedJSON<Params>): Promise<TypedJSON<{
        response_code: unknown;
        base64_body: TypedBase64<TypedJSON<JSONRpcResponse<Result, Errors>>>;
    }> | TypedJSON<JSONRpcReturnCodeApiReturnCode> | TypedJSON<ErrorCode<API_RETURN_CODE.BAD_ARG_INVALID_JSON>> | TypedJSON<ErrorCode<API_RETURN_CODE.FAIL>>>;
};
export interface ICoreRpc extends CoreRpc {
    ...
    get_current_core_tx_expiration_median: CoreMethod<DAEMON_RPC_GET_CURRENT_CORE_TX_EXPIRATION_MEDIAN_REQUEST, DAEMON_RPC_GET_CURRENT_CORE_TX_EXPIRATION_MEDIAN_RESPONSE>;
...
export {};
//# sourceMappingURL=core-rpc.type.d.ts.map