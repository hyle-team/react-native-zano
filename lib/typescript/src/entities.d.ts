...
export declare enum GUI_TX_TYPE {
    NORMAL = 0,
    PUSH_OFFER = 1,
    UPDATE_OFFER = 2,
    CANCEL_OFFER = 3,
...
export declare enum contract_state {
    proposal_sent = 1,
    contract_accepted = 2,
...
export declare enum TX_SERVICE_ATTACHMENT {
    ENCRYPT_BODY = 1,
    DEFLATE_BODY = 2,
    ENCRYPT_BODY_ISOLATE_AUDITABLE = 4,
    ENCRYPT_ADD_PROOF = 8
}
...
export declare enum ASSET_DESCRIPTOR_OPERATION_VERSION {
    HF4_VER = 1,
    HF5_VER = 2,
    LAST_VER = 2
}
export declare enum ASSET_DESCRIPTOR_OPERATION_TYPE {
    UNDEFINED = 0,
    REGISTER = 1,
    EMIT = 2,
    UPDATE = 3,
...
export declare enum BASIC_RESPONSE_STATUS {
    OK = "OK",
    BUSY = "BUSY",
    NOT_FOUND = "NOT_FOUND",
    FAILED = "FAILED"
}
export declare enum API_RETURN_CODE {
    OK = "OK",
    FAIL = "FAILED",
    NOT_FOUND = "NOT_FOUND",
...
export declare enum JSON_RPC_ERROR_CODE {
...
export declare enum WALLET_RPC_ERROR_CODE {
    UNKNOWN_ERROR = -1,
    WRONG_ADDRESS = -2,
    DAEMON_IS_BUSY = -3,
...
export declare enum wallet_state {
    initial = 0,
    synchronizing = 1,
    ready = 2,
    error = 3
...
export declare enum CORE_RPC_ERROR_CODE {
    WRONG_PARAM = -1,
    TOO_BIG_HEIGHT = -2,
...
export declare enum daemon_network_state {
    connecting = 0,
    synchronizing = 1,
    online = 2,
    loading_core = 3,
...
export declare enum RANDOM_OUTPUTS_FOR_AMOUNTS_FLAGS {
    COINBASE = 1,
    NOT_ALLOWED = 2,
    POS_COINBASE = 4
}
