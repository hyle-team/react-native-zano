...
export interface PlainWallet extends HybridObject<{
    ios: 'c++';
    android: 'c++';
}> {
    init(host: string, port: string, working_dir: string, log_level: ZanoLogLevel): Promise<string>;
    reset(): string;
    ...
    get_wallet_status(instance_id: number): Promise<string>;
...
//# sourceMappingURL=plain-wallet.nitro.d.ts.map